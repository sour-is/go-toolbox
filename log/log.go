...
func Print(v ...interface{}) { Outputs(logger, 1, event.VerbInfo, fmt.Sprint(v...)) }

// Printf calls Output to print to the standard logger.
// Arguments are handled in the manner of fmt.Printf.
func Printf(format string, v ...interface{}) {
	Outputs(logger, 1, event.VerbInfo, fmt.Sprintf(format, v...))
}
...
func Write(r io.Reader) {
	...
	Outputs(logger, 1, event.VerbInfo, buf.String())
}
...
func Tee(r io.ReadCloser) (w io.ReadCloser) {
	...
	Outputs(logger, 1, event.VerbInfo, str)
...
func Fatal(v ...interface{}) {
	Outputs(logger, 1, event.VerbCritical, fmt.Sprint(v...))
	os.Exit(1)
}

// Fatalf is equivalent to Printf() followed by a call to os.Exit(1).
func Fatalf(format string, v ...interface{}) {
	Outputs(logger, 1, event.VerbCritical, fmt.Sprintf(format, v...))
	os.Exit(1)
}
...
func Panic(v ...interface{}) {
	s := fmt.Sprint(v...)
	Outputs(logger, 1, event.VerbError, s)
	panic(s)
}
...
func Debug(v ...interface{}) { Outputs(logger, 1, event.VerbDebug, fmt.Sprint(v...)) }

// Debugf formats output to logger with DEBUG level.
func Debugf(format string, v ...interface{}) {
	Outputs(logger, 1, event.VerbDebug, fmt.Sprintf(format, v...))
}
...
func Debugw(r io.Reader) {
	buf := new(bytes.Buffer)
	buf.ReadFrom(r)
	Outputs(logger, 1, event.VerbDebug, buf.String())
}

// Info outputs to logger with INFO level.
func Info(v ...interface{}) { Outputs(logger, 1, event.VerbInfo, fmt.Sprint(v...)) }
...
func Notice(v ...interface{}) { Outputs(logger, 1, event.VerbNotice, fmt.Sprint(v...)) }

// Noticef formatted outputs to logger with NOTICE level.
func Noticef(format string, v ...interface{}) {
	Outputs(logger, 1, event.VerbNotice, fmt.Sprintf(format, v...))
}
...
func Noticew(r io.Reader) {
	buf := new(bytes.Buffer)
	buf.ReadFrom(r)
	Outputs(logger, 1, event.VerbNotice, buf.String())

}

// Warning outputs to logger with WARNING level.
func Warning(v ...interface{}) { Outputs(logger, 1, event.VerbWarning, fmt.Sprint(v...)) }

// Warningf formatted outputs to logger with WARNING level.
func Warningf(format string, v ...interface{}) {
	Outputs(logger, 1, event.VerbWarning, fmt.Sprintf(format, v...))
}
...
func Warningw(r io.Reader) {
	buf := new(bytes.Buffer)
	buf.ReadFrom(r)
	Outputs(logger, 1, event.VerbWarning, buf.String())

}

// Error outputs to logger with ERROR level.
func Error(v ...interface{}) { Outputs(logger, 1, event.VerbError, fmt.Sprint(v...)) }

// Errorf formatted outputs to logger with ERROR level.
func Errorf(format string, v ...interface{}) {
	Outputs(logger, 1, event.VerbError, fmt.Sprintf(format, v...))
}
...
func Errorw(r io.Reader) {
	buf := new(bytes.Buffer)
	buf.ReadFrom(r)
	Outputs(logger, 1, event.VerbError, buf.String())
}

// Critical outputs to logger with CRITICAL level.
func Critical(v ...interface{}) { Outputs(logger, 1, event.VerbCritical, fmt.Sprint(v...)) }
...
func Criticalw(r io.Reader) {
	buf := new(bytes.Buffer)
	buf.ReadFrom(r)
	Outputs(logger, 1, event.VerbCritical, buf.String())
}

// Debugs structured debug message
func Debugs(msg string, tags ...interface{}) { Outputs(logger, 1, event.VerbDebug, msg, tags...) }
...
func Errors(msg string, tags ...interface{}) { Outputs(logger, 1, event.VerbError, msg, tags...) }
